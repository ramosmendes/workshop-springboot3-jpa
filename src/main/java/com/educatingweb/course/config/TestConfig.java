...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		User u1 = new User("Maria Brown", "maria@gmail", "50508-1010", "88950061");
		User u2 = new User("Alex Green", "alex@gmail", "50508-1010", "88950061");
		...
		Order o4 = new Order(Instant.parse("2019-07-22T15:21:22Z"), OrderStatus.CANCELED, u1);

		orderRepository.saveAll(Arrays.asList(o1, o2, o3, o4));

		Category c1 = new Category("Games");
		Category c2 = new Category("Tools");
		Category c3 = new Category("Films");
		...
		Payment pay1 = new Payment(Instant.parse("2019-07-21T03:42:10Z"), o2);
		o2.setPayment(pay1);
